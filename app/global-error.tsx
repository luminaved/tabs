    ...
    <html lang="ru">
      ...
      >
        <div style={{ maxWidth: '28rem', textAlign: 'center' }}>
          ...
          {/* Как и в app/(site)/error.tsx: про связь — версией и последней
              строкой, потому что чаще причина на нашей стороне. */}
          <p style={{ margin: '0 0 1.75rem', color: '#968f81', lineHeight: 1.6 }}>
            Произошла непредвиденная ошибка. Попробуйте обновить страницу — если
            не помогает, дело может быть в соединении с сайтом.
          </p>
          <button
            type="button"
            onClick={reset}
