...
export const viewerKeys = {
  ...
  /**
   * Запись квинт: стандартная («G#5») или ладами («4В») — гитарная запись из
   * русских табов. Общая на весь песенник, и это не экономия на ключах: то,
   * какая запись читается с листа быстрее, — свойство ЧЕЛОВЕКА, а не песни.
   * Кто вырос на табах, тому «4В» привычнее везде и всегда, и переспрашивать
   * об этом на каждом разборе значило бы делать вид, что привычка меняется от
   * песни к песне.
   */
  fifthsAsFrets: `${PREFIX}fifthsAsFrets`,
};
